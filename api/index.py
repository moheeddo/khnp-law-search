...
ADVISOR_SCENARIOS = [
    ...
    {"keywords":["발전","전기","전력","송전","변전","배전","전력거래","계통"],"category":"전력사업","recommendations":[{"law":"전기사업법","type":"시행령","reason":"발전·송전·배전사업 허가, 전력거래","priority":"필수","key_articles":"제7조"},{"law":"전력기술관리법","type":"법률","reason":"전력기술자, 전력시설물 설계·감리","priority":"필수","key_articles":"제2조"},{"law":"에너지법","type":"시행규칙","reason":"국가에너지기본계획","priority":"권장","key_articles":"제2조, 제4조"}]},
    ...
    {"keywords":["안전","산업재해","재해","사고","중대재해"],"category":"안전관리","recommendations":[{"law":"산업안전보건법","type":"법률","reason":"사업장 안전보건 의무","priority":"필수","key_articles":"제5조, 제63조"},{"law":"산업안전보건기준에관한규칙","type":"고용노동부령","reason":"안전보건 기준 상세","priority":"필수","key_articles":"제3조, 제38조"},{"law":"원자력안전법","type":"법률","reason":"원자력시설 안전규제","priority":"해당시","key_articles":"제10조, 제20조"}]},
...
FOCUS_GUIDES = {
    "sw": {"title":"SW 개발 용역 발주 가이드","steps":[
        {"do":"1. 대가 산정","detail":"소프트웨어진흥법 제20조 · SW사업 대가산정 가이드(과기부 고시) 기준으로 기능점수(FP) 또는 투입공수 방식으로 산정","law":"소프트웨어진흥법 제20조"},
        {"do":"2. 과업지시서(RFP) 작성","detail":"요구사항 정의서, 기술규격, 산출물 목록, 검수 기준 명시. 지능정보화기본법 제13조 참조","law":"전자정부법 제64조"},
        {"do":"3. 입찰·제안서 평가","detail":"협상에 의한 계약(시행령 제43조) 적용. 기술능력 평가 60%+가격 40% 배점","law":"시행령 제43조"},
        {"do":"4. 계약 체결","detail":"계약보증금 10%, 저작권 귀속 조항, 하도급 제한(소프트웨어진흥법 제24조 일괄하도급 금지) 명시","law":"소프트웨어진흥법 제24조"},
        {"do":"5. 사업 수행·관리","detail":"주간·월간 보고, 중간산출물 검토, 변경 관리. 투입인력 변경 시 발주자 승인","law":""},
        {"do":"6. 검수·하자담보","detail":"완료 후 검수(14일 이내), 하자담보책임 1년(소프트웨어진흥법 제43조). 소스코드·기술문서 인수","law":"소프트웨어진흥법 제43조"},
    ],"must_check":["SW사업 대가산정 가이드(과기부 고시) 확인","FP(기능점수) 또는 투입공수 방식 선택","일괄 하도급 금지 (부분 하도급만 가능, 50% 이내)","저작권·지식재산권 귀속 계약서 명시","하자담보책임기간 1년 (계약서 명기)","검수 완료 후 14일 이내 대가 지급"]},
    "공사": {"title":"공사 발주 가이드","steps":[
        {"do":"1. 설계·사양 확정","detail":"실시설계 완료, 공사비 산출, 안전관리계획 수립","law":"건설산업기본법 제22조"},
        {"do":"2. 예정가격·입찰공고","detail":"원가계산 또는 실적공사비, 7일 이상 공고","law":"시행령 제9조, 국가계약법 제7조"},
        {"do":"3. 적격심사·계약","detail":"시공능력·실적·가격 종합 평가, 계약보증금 15%","law":"시행령 제42조"},
        {"do":"4. 시공·안전관리","detail":"감리 배치, 산업안전보건법 준수, 기성검사","law":"산업안전보건법 제63조"},
        {"do":"5. 준공·하자담보","detail":"준공검사, 하자보수보증금 납부, 하자담보 2~3년","law":"국가계약법 제14조"},
    ],"must_check":["건설업 등록 업체 확인","안전관리계획 수립 (1억 이상)","하도급 사전 승인","설계변경 시 서면 승인 필수","하자담보기간: 건축2년, 토목3년"]},
    "물품": {"title":"물품 구매 발주 가이드","steps":[
        {"do":"1. 수요·규격 확정","detail":"물품 사양서, 수량, 납품 조건 확정","law":""},
        {"do":"2. 예정가격·입찰","detail":"시장조사 3건 이상, 나라장터 전자입찰 또는 MAS","law":"시행령 제9조"},
        {"do":"3. 낙찰·계약 체결","detail":"최저가 또는 적격심사, 계약보증금 10%","law":"국가계약법 제10조"},
        {"do":"4. 납품·검수","detail":"납품기한 내 인도, 규격·품질 검수","law":"국가계약법 제14조"},
        {"do":"5. 대가 지급","detail":"검수 후 14일 이내 지급","law":"국가계약법 제15조"},
    ],"must_check":["나라장터 MAS 활용 가능 여부 확인","검수 체크리스트 사전 수립","지체상금률 계약서 명기 (0.75/1000)"]},
    "수의계약": {"title":"수의계약 발주 가이드","steps":[
        {"do":"1. 수의계약 사유 확인","detail":"시행령 제26조 해당 여부 확인 (5천만원 미만 등)","law":"시행령 제26조"},
        {"do":"2. 견적서 징수","detail":"2인 이상 견적서, 1인 견적 시 사유 명시","law":"시행령 제30조"},
        {"do":"3. 계약 체결","detail":"수의계약 사유서 작성, 계약심사(한도 초과 시)","law":"공기업규칙 제7조"},
    ],"must_check":["추정가격이 한도액 이내인지 확인","수의계약 사유서 작성 필수","견적서 2인 이상 징수 (감사 지적 방지)","특정 업체 반복 계약 시 특혜 시비 주의"]},
}

def get_focus_guide(query):
    """검색어에 맞는 핵심 가이드 반환"""
    q = query.lower()
    expanded = expand_query(query).lower()
    if any(kw in expanded for kw in ["소프트웨어","sw","it","정보시스템","전산","시스템개발","앱","홈페이지","웹"]):
        return FOCUS_GUIDES["sw"]
    if any(kw in q for kw in ["공사","건설","시공","토목"]):
        return FOCUS_GUIDES["공사"]
    if any(kw in q for kw in ["수의계약","수의","긴급"]):
        return FOCUS_GUIDES["수의계약"]
    if any(kw in q for kw in ["물품","구매","납품","자재","기자재","수산물","식품"]):
        return FOCUS_GUIDES["물품"]
    return None
...
def get_reference_data(query, recommendations):
    ...
    ref["guide"] = get_focus_guide(query)
