...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-04-04 | 실무 UX 개선: 랜딩 "자주 찾는 정보" 빠른 참고 카드 6종 추가 (수의계약 한도, 보증금 비율, 지체상금률, 입찰공고 기간, 선급금 한도, 하자담보 기간), 검색 결과 상단 "핵심 한줄 요약" 카드 추가 (AI 분석·계약방식·위험도·법령 수 배지) |
| 2026-04-04 | 자동완성 고도화: 계약 사례(10건)·실무 Q&A(10건) 미리보기 추가, Q&A 선택 시 toast 즉시 표시, ac-icon.qa/case 스타일 추가 |
